...
TEST(textFiguresArray, totalSquare) {
    FiguresArray arr;
    Point p1(2, -3), p2(3, -1), p3(5, -3), p4(4, 4), p5(4, -4);
    Pentagon fig1(p1, p2, p3, p4, p5);
    Point p6(-1, -1), p7(-2, -3), p8(-4, -3), p9(2, 3), p10(5, 1), p11(-5, -1);
    Hexagon fig2(p6, p7, p8, p9, p10, p11);
    double expectedTotalSquare = fig1.square() + fig2.square();

    arr.push_back(&fig1);
    arr.push_back(&fig2);

    ASSERT_TRUE(arr.totalSquare() == expectedTotalSquare);
}
